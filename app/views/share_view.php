		...
		<?php 
			...
			foreach ($data['goods'][0] as $key) {
				...
				printf('
						...
						',$key["m_img"],$key["name"],$key["desc"],$key["weight"],$key["img"],$key["id"],$key["id"],$key["price"],$key["id"],$key["to_price"],$key["do_price"],$key["to_price"],$key["id"],$key["to_price"],$key["name"],$key["desc"]);
			}
		 ?>
	</div>
</div>
